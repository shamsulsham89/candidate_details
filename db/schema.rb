...
ActiveRecord::Schema.define(:version => 20130803094900) do
  ...
  create_table "candidate_forms", :force => true do |t|
    t.string   "name"
    t.string   "contact"
    t.string   "email"
    t.date     "birth_date"
    ...
    t.string   "other_visa_status"
    t.string   "other_language"
    t.string   "other_experience_in_sp"
  end
